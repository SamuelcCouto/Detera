          ...
          return (
            ...
            >
              ...
              {/* O símbolo em miniatura, sob o "A" — só na versão animada
                  ...
                  Cai junto com a letra que o carrega. `652` é o centro do
                  "A" (as pernas vão de 596 a 708); a escala de 1.3 dá 41.6
                  de largura por 52 de altura, o suficiente pra continuar
                  legível nesse tamanho. */}
              {ultima && animado ? (
                <g className="marca-viva" transform="translate(631 140) scale(1.3)" fillRule="nonzero">
                  <g fill="currentColor">
                    <path className="marca-placa marca-placa--esq" d={MARCA_METADE} />
                    <g transform="translate(32 0) scale(-1 1)">
                      <path className="marca-placa marca-placa--dir" d={MARCA_METADE} />
